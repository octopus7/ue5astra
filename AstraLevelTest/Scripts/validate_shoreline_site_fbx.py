...
def main():
    ...
    report = {'passed': unchanged and all(r['passed'] for r in results.values()),
              ...
              'scope': 'Fresh Blender FBX import; compare exact saved review geometry, dimensions, pivot/axes/units, triangle topology, material slots, loop UVs, ShoreData, welded manifold topology and positive signed volume. UE validation is separate.',
